#!/bin/bash
# Paper Replication: Table 1 from 2602.09314v1
# AdamW and Muon on LLaMA3 320M, B=256, 3.2B tokens
# 4 GPUs (256 not divisible by 5), torch.compile enabled
#
# NOTE: Must run inside the 'torchtitan' Docker container.
# From host:
#   docker exec -it torchtitan bash -c 'cd /home/torchtitan && bash env/dgx/run_320m_paper_replication_20260311.sh'
#
# Inside container:
#   cd /home/torchtitan
#   STEPS=10 TIME_LIMIT=-1 bash env/dgx/run_320m_paper_replication_20260311.sh          # Test run
#   bash env/dgx/run_320m_paper_replication_20260311.sh                                  # Full run
#   bash env/dgx/run_320m_paper_replication_20260311.sh adamw                            # Single optimizer
#   DRY_RUN=1 bash env/dgx/run_320m_paper_replication_20260311.sh                        # Dry run
...
# Directories
DATE_TAG="20260311"
LOG_DIR="./logs/320m_paper_replication_${DATE_TAG}"
mkdir -p "$LOG_DIR"
...
echo "============================================================"
echo "  Paper Replication: 2602.09314v1 Table 1"
