"""
Config registry for Dion optimizer experiments.

Usage:
    python -m torchtitan.train \
        --module ortho_matrix.dion \
        --config llama3_160m_dion \
        --training.steps 2000
"""
...
# ======================================================================
# Dion optimizer container
# ======================================================================

class DionContainer(BaseHybridOptimizersContainer):
    """Dion (low-rank power iteration) + AdamW scalar optimizer container."""
...
def llama3_160m_dion() -> Trainer.Config:
    ...
    return Trainer.Config(
        ...
        optimizer=DionContainer.Config(
            lr=0.02,
            rank_fraction=0.25,
            weight_decay=0.0,
            scalar_lr=3e-4,
...
def llama3_debug_dion() -> Trainer.Config:
    ...
    config.optimizer = DionContainer.Config(
        lr=0.02,
        rank_fraction=0.25,
        weight_decay=0.0,
        scalar_lr=3e-4,
